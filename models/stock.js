...
Stock.prototype = {
	/**
	 * 获取某股票历史数据
	 * @param args股票参数数组 {object} => {symbol: "sh000001", begin_date: "20150101", end_date: "20150810"}
	...
	fetchHistoryBat: function (args, fn) {	
		async.mapLimit(args, 10, function(arg, callback){
        	fetch(arg, callback);
			...
			if (typeof(symbol) === "undefined") {
				...
				superagent.get(url)
					.end(function (err, sres) {
						...
						var reData = {symbol: symbol, data: data};
